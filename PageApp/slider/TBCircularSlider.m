...
-(id)initWithFrame:(CGRect)frame{
    ...
    if(self){
        ...
        _textField.textColor = [UIColor colorWithRed:.0 green:.0 blue:.200 alpha:0.2];
        ...
        UIImageView *dot =[[UIImageView alloc] initWithFrame:CGRectMake(self.frame.size.width/2-radius,frame.size.height/2-radius,radius*2,radius*2)];
        dot.image=[UIImage imageNamed:@"circle"];
...
-(void) drawTheHandle:(CGContextRef)ctx{
    ...
    CGContextFillEllipseInRect(ctx, CGRectMake(handleCenter.x, handleCenter.y, TB_LINE_WIDTH+3, TB_LINE_WIDTH+3));
